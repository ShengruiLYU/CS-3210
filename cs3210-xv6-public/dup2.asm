...
main(int argc, char *argv[])
{
  ...
  mkdir("/dir");
  13:	68 80 07 00 00       	push   $0x780
  18:	e8 4d 03 00 00       	call   36a <mkdir>
  int oldfd = open("/dir/file", O_CREATE|O_WRONLY);
  1d:	59                   	pop    %ecx
  1e:	5b                   	pop    %ebx
  1f:	68 01 02 00 00       	push   $0x201
  24:	68 85 07 00 00       	push   $0x785
  int newfd = 10;
  printf(0,"oldfd = %d\n",oldfd);
...
main(int argc, char *argv[])
{
  ...
  mkdir("/dir");
  int oldfd = open("/dir/file", O_CREATE|O_WRONLY);
  2b:	e8 12 03 00 00       	call   342 <open>
  int newfd = 10;
  printf(0,"oldfd = %d\n",oldfd);
...
main(int argc, char *argv[])
{
  ...
  printf(0,"oldfd = %d\n",oldfd);
  35:	50                   	push   %eax
  36:	68 8f 07 00 00       	push   $0x78f
  3b:	6a 00                	push   $0x0
  3d:	e8 1e 04 00 00       	call   460 <printf>
  42:	83 c4 10             	add    $0x10,%esp
  45:	eb 28                	jmp    6f <main+0x6f>
  ...
  if (dup2(oldfd,newfd) == -1)
  	...
  	printf(0,"%s\n","success" );
  56:	68 ab 07 00 00       	push   $0x7ab
  5b:	68 a7 07 00 00       	push   $0x7a7
  60:	6a 00                	push   $0x0
  62:	e8 f9 03 00 00       	call   460 <printf>
  ...
  for (newfd =0;newfd<10;newfd++){
  6a:	83 fb 0a             	cmp    $0xa,%ebx
  6d:	74 40                	je     af <main+0xaf>
  printf(0,"newfd = %d\n",newfd);
  6f:	83 ec 04             	sub    $0x4,%esp
  72:	53                   	push   %ebx
  73:	68 9b 07 00 00       	push   $0x79b
  78:	6a 00                	push   $0x0
  7a:	e8 e1 03 00 00       	call   460 <printf>
  if (dup2(oldfd,newfd) == -1)
  7f:	58                   	pop    %eax
  80:	5a                   	pop    %edx
  81:	53                   	push   %ebx
  82:	56                   	push   %esi
  83:	e8 22 03 00 00       	call   3aa <dup2>
  88:	83 c4 10             	add    $0x10,%esp
  8b:	83 f8 ff             	cmp    $0xffffffff,%eax
  8e:	75 c0                	jne    50 <main+0x50>
  	printf(0,"%s\n"," the newfd is already taken or oldfd is not allocated");
  ...
  if (dup2(oldfd,newfd) == -1)
  	printf(0,"%s\n"," the newfd is already taken or oldfd is not allocated");
  96:	68 b4 07 00 00       	push   $0x7b4
  9b:	68 a7 07 00 00       	push   $0x7a7
  a0:	6a 00                	push   $0x0
  ...
  for (newfd =0;newfd<10;newfd++){
  aa:	83 fb 0a             	cmp    $0xa,%ebx
  ad:	75 c0                	jne    6f <main+0x6f>
  if (dup2(oldfd,newfd) == -1)
  	printf(0,"%s\n"," the newfd is already taken or oldfd is not allocated");
  else
  	printf(0,"%s\n","success" );
  ...
  exit();
  af:	e8 4e 02 00 00       	call   302 <exit>
  b4:	66 90                	xchg   %ax,%ax
  b6:	66 90                	xchg   %ax,%ax
  b8:	66 90                	xchg   %ax,%ax
  ba:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ff:	f7 f6                	div    %esi
 401:	0f b6 92 f4 07 00 00 	movzbl 0x7f4(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 578:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 57b:	b8 ec 07 00 00       	mov    $0x7ec,%eax
...
free(void *ap)
{
 ...
 657:	89 08                	mov    %ecx,(%eax)
  freep = p;
 659:	a3 94 0a 00 00       	mov    %eax,0xa94
}
 65e:	5b                   	pop    %ebx
 65f:	5e                   	pop    %esi
 660:	5f                   	pop    %edi
 ...
 67a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 67d:	a3 94 0a 00 00       	mov    %eax,0xa94
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 15 94 0a 00 00    	mov    0xa94,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 6ef:	76 3f                	jbe    730 <malloc+0xa0>
    ...
    if(p == freep)
 6f1:	39 05 94 0a 00 00    	cmp    %eax,0xa94
 ...
 716:	e8 e5 fe ff ff       	call   600 <free>
  return freep;
 71b:	8b 15 94 0a 00 00    	mov    0xa94,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 754:	eb e9                	jmp    73f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 756:	c7 05 94 0a 00 00 98 	movl   $0xa98,0xa94
 75d:	0a 00 00 
 760:	c7 05 98 0a 00 00 98 	movl   $0xa98,0xa98
 767:	0a 00 00 
    base.s.size = 0;
 76a:	b8 98 0a 00 00       	mov    $0xa98,%eax
 76f:	c7 05 9c 0a 00 00 00 	movl   $0x0,0xa9c
 776:	00 00 00 
