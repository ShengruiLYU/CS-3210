...
main(int argc, char *argv[])
{
  12:	83 ec 2c             	sub    $0x2c,%esp
  struct rtcdate r;

  if (date(&r)) {
  15:	53                   	push   %ebx
  16:	e8 37 03 00 00       	call   352 <date>
  ...
  22:	50                   	push   %eax
  23:	50                   	push   %eax
  24:	68 30 07 00 00       	push   $0x730
  29:	6a 02                	push   $0x2
  2b:	e8 e0 03 00 00       	call   410 <printf>
    exit();
  30:	e8 7d 02 00 00       	call   2b2 <exit>
  }
  ...
  38:	53                   	push   %ebx
  39:	e8 14 03 00 00       	call   352 <date>
  printf(1,"%d-%d-%d, %d:%d:%d",r.year,r.month,r.day,r.hour,r.minute,r.second);
  3e:	ff 75 e0             	pushl  -0x20(%ebp)
  41:	ff 75 e4             	pushl  -0x1c(%ebp)
  44:	ff 75 e8             	pushl  -0x18(%ebp)
  47:	ff 75 ec             	pushl  -0x14(%ebp)
  4a:	ff 75 f0             	pushl  -0x10(%ebp)
  4d:	ff 75 f4             	pushl  -0xc(%ebp)
  50:	68 3d 07 00 00       	push   $0x73d
  55:	6a 01                	push   $0x1
  57:	e8 b4 03 00 00       	call   410 <printf>

  exit();
  5c:	83 c4 30             	add    $0x30,%esp
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3af:	f7 f6                	div    %esi
 3b1:	0f b6 92 58 07 00 00 	movzbl 0x758(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 528:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 52b:	b8 50 07 00 00       	mov    $0x750,%eax
...
free(void *ap)
{
 ...
 607:	89 08                	mov    %ecx,(%eax)
  freep = p;
 609:	a3 f4 09 00 00       	mov    %eax,0x9f4
}
 60e:	5b                   	pop    %ebx
 60f:	5e                   	pop    %esi
 610:	5f                   	pop    %edi
 ...
 62a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 62d:	a3 f4 09 00 00       	mov    %eax,0x9f4
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 6ec:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 6ef:	89 15 f4 09 00 00    	mov    %edx,0x9f4
      return (void*)(p + 1);
 ...
 704:	eb e9                	jmp    6ef <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 706:	c7 05 f4 09 00 00 f8 	movl   $0x9f8,0x9f4
 70d:	09 00 00 
 710:	c7 05 f8 09 00 00 f8 	movl   $0x9f8,0x9f8
 717:	09 00 00 
    base.s.size = 0;
 71a:	b8 f8 09 00 00       	mov    $0x9f8,%eax
 71f:	c7 05 fc 09 00 00 00 	movl   $0x0,0x9fc
 726:	00 00 00 
